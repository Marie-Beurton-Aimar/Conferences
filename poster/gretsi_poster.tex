...
\Put(6,80){\includegraphics[scale=1.8]{images/inra}}
  ...
  {
	  \begin{itemize}
   		 \item \textbf{\textcolor{blocktitletextcolor}{Morphometry}} analysis is a way to characterize the shape variations of the organisms,
   		 ...
   		 \item \textcolor{blocktitletextcolor}{\textbf{Morphometrics}} are also used to \textcolor{blocktitletextcolor}{\textbf{classify}} the objects in different groups.
    	  \end{itemize}
%    	  \begin{tikzfigure}
%    	  	\centering
...
%    	  \end{tikzfigure}
  ...
  \blocknode{Manual landmarks}%
  {
  	\begin{itemize}
  		...
  		\item They are usually \textcolor{blocktitletextcolor}{\textbf{defined}} by biologists \textcolor{blocktitletextcolor}{\textbf{manually}}.,
  		\item Images show manual landmarks in \textcolor{blocktitletextcolor}{\textbf{beetle mandibles}} \\ belonging to our sample. 
 ...
 \blocknode%
  {Segmentation}%
  {
    \begin{dingautolist}{182}
    		\itemcolor{colorone}
		\item Converting the image to binary one by applying a \textcolor{blocktitletextcolor}{\textbf{threshold}} determined by histogram analysis\cite{leestimating}.
...
\blocknode{SIFT and landmarks}%
  {   
    ...
    \begin{dingautolist}{182}
    		\itemcolor{colorone}
    		\item A \textcolor{blocktitletextcolor}{\textbf{patch}} $P_m$ is initialized at each manual landmark of model image (size of $9\times9$),
    		...
    		\item At the end, the pixel that has the \textcolor{blocktitletextcolor}{\textbf{minimum distance}} with $P_m$ is kept.
    \end{dingautolist}
  }
...
\blocknode{Conclusions}
{
	\begin{itemize}
		...
		\item The results show that method \textcolor{blocktitletextcolor}{\textbf{succeed in locating}} all landmarks in  request images,
		\item The accuracy of method is sufficient to be \textcolor{blocktitletextcolor}{\textbf{proposed to biologists}} as a \textcolor{blocktitletextcolor}{\textbf{replacement of manual positioning}}, and to characterize the shape.
	\end{itemize}
}
