...
\begin{figure}[h]
\centering
\subfloat[Left mandible]{\label{figrbox2}\includegraphics[width=0.2\textwidth]{./images/lm}}~~
\subfloat[Right mandible]{\label{figrbox1}\includegraphics[width=0.2\textwidth]{./images/rm}}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.40\textwidth]{./images/illustration_SIFT}
...
\centering
\subfloat[Left mandible]{\label{figrbox2}\includegraphics[width=0.20\textwidth]{./images/mg_rs}}~~
\subfloat[Right mandible]{\label{figrbox1}\includegraphics[width=0.20\textwidth]{./images/md_rs}}
...
\begin{figure}[h]
\centering
\subfloat[Set of right mandibles.]{\label{figmdresult}\includegraphics[width=0.2\textwidth]{./images/mdresult}}~~
\subfloat[Set of left mandibles.]{\label{figmgresult}\includegraphics[width=0.2\textwidth]{./images/mgresult}}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.45\textwidth]{./images/md_chartlms}
